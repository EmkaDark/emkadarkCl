...
export default function RootLayout({
  ...
  return (
    ...
    })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=103869830', 'ym');

    ym(103869830, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
